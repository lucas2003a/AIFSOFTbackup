...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-04-2024 a las 14:06:11
...
(27, 1, 'lote', NULL, 'SIN VENDER', 'AC00001', 1, 'Urbanización Alpha', 'USD', 300.00, 0, 'Partida 001', '45', '55', '{\"clave\":[\"\"],\"valor\":[\"\"]}', 80000.00, '2024-03-23', '2024-04-04', NULL, 1, '{\"clave\" :[\"\"], \"valor\":[\"\"]}'),
...
(41, 1, 'LOTE', NULL, 'SIN VENDER', 'CA00001', 4, 'av santa rosa#541', 'SOL', 300.00, 1, '', NULL, NULL, '{\"clave\":[\"\"],\"valor\":[\"\"]}', 0.00, '2024-04-04', '2024-04-04', NULL, 1, '{\"clave\" :[\"\"], \"valor\":[\"\"]}'),
(42, 1, 'LOTE', NULL, 'SIN VENDER', 'CA00000', 5, 'av santa rosa#541', 'SOL', 30.00, 20, '', '22', '13', '{\"clave\":[\"y\",\"x\",\"\"],\"valor\":[\"15\",\"16\",\"\"]}', 0.00, '2024-04-04', '2024-04-05', NULL, 1, '{\"clave\" :[\"\"], \"valor\":[\"\"]}'),
(44, 1, 'LOTE', NULL, 'SIN VENDER', 'a222222', 65, 'av santa rosa#541', 'SOL', 300.00, 12, '', NULL, NULL, '{\"clave\":[\"\"],\"valor\":[\"\"]}', 0.00, '2024-04-05', NULL, NULL, 1, '50000'),
(45, 1, 'LOTE', NULL, 'SIN VENDER', 'a222224', 123, 'av santa rosa#541', 'SOL', 300.00, 12, '12', NULL, NULL, '{\"clave\":[\"y\",\"x\",\"\"],\"valor\":[\"12\",\"15\",\"\"]}', 0.00, '2024-04-05', '2024-04-05', NULL, 1, '{\"clave\" :[\"\"], \"valor\":[\"\"]}'),
(48, 1, 'LOTE', NULL, 'SIN VENDER', 'AC20060', 127, 'av santa rosa#541', 'SOL', 360.00, 12, '', NULL, NULL, '{\"clave\":[\"\"],\"valor\":[\"\"]}', 0.00, '2024-04-05', NULL, NULL, 1, '1200000'),
(49, 1, 'LOTE', NULL, 'SIN VENDER', '1230000', 127, 'av santa rosa#541', 'SOL', 323.00, 12, '', NULL, NULL, '{\"clave\":[\"\"],\"valor\":[\"\"]}', 0.00, '2024-04-05', NULL, NULL, 1, '315');
...
INSERT INTO `contratos` (`idcontrato`, `idcliente`, `idconyugue`, `idrepresentante_primario`, `idrepresentante_secundario`, `tipo_cambio`, `estado`, `fecha_contrato`, `create_at`, `update_at`, `inactive_at`, `idusuario`, `detalles`, `tipo_contrato`) VALUES
...
(36, 62, 0, 0, 0, '2024-04-05 03:42:32');
...
(1, 'c48595be5a783c242327a77047927d36be14c42b.jpg', 4, 'A-12 SAN BLAS', 'RESIDENCIAL SAN BLAS', NULL, NULL, 1008, 'Dirección A-12 SAN BLAS', '2024-03-23', '2024-04-05', NULL, 1, '{\"clave\":[\"\"],\"valor\":[\"\"]}'),
...
(62, NULL, 4, 'A-12 SAN BENITO', 'SAN BENITO', '28', '28', 1008, 'av santa rosa#541', '2024-04-05', NULL, NULL, 1, '{\"clave\":[\"12\",\"\"],\"valor\":[\"3\",\"\"]}');
...
--
ALTER TABLE `metricas`
  MODIFY `idmetrica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
